...
NDiplomacy = {
	...
	HRE_FOREIGN_CONTROL_PENALTY = -0.003,			-- Each foreign-controlled province in the empire (owned or vassalised) lowers IA by this amount
	...
	PO_ANNEX_PRESTIGE = 0.15, 						-- _DDEF_PO_ANNEX_PRESTIGE = 10, (No effect on loser :)
	...
	PEACE_COST_RELEASE_VASSAL = 0.25,					-- Release vassal (scales by province wealth)
	...
	PEACE_COST_RELEASE = 1, 						-- _DDEF_PEACE_COST_RELEASE_ Base Peace cost for releasing an annexed country (also increases with nr of provinces)
	...
	ANNEX_DIP_COST_PER_DEVELOPMENT = 4,			-- per development
	...
	HRE_AUTHORITY_JOIN_EMPIRE = 2.5,
	HRE_AUTHORITY_LEAVE_EMPIRE = -5,
	HRE_AUTHORITY_PROVINCE_JOIN = 0.05,
...
NCountry = {
	...
	STARTING_ARMY_SIZE = 0.30,						-- Percentage of force limit
	...
	REVOLT_SIZE_DEVELOPMENT_MULTIPLIER = 0.07,		-- Multiplied with the province's development
	REVOLT_SIZE_BASE = 3,
	REVOLT_TECH_IMPACT = 0.02, 			-- % each tech increases size of rebels by this percent.
...
NEconomy = {
	...
	MISSIONARY_MAINTENANCE_DEVELOPMENT_CAP = 120,		-- Where dev will get capped by the system for calculations.
...
NAI = {
	...
	CHARTER_COMPANY_DEVELOPMENT_RELUCTANCE = 1,				-- How much development needed to add one reluctance
